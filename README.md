...
应用和安装文件名为“Lili”，宠物本人仍叫“六毛”。`v0.11.0` 新增可选的“搭子自习室”；不登录时仍是完整的纯离线桌宠。动作统一保留六束紧密红色头发、蓝色发梢、可见小嘴、蓝色锯齿脸、黄色连体衣和粉色爱心。
...
- 新增 36 张修正版全幅动作，包括办公、夜读、耳机、吉他、鼓、钢琴、喝茶、睡觉、登山、运动、合影和荒野国王；
...
- 计时期间六毛会轮换敲电脑、夜读、指着思考和拿保温杯；休息时喝茶、晒太阳、睡觉或听歌；完成时比心、送花、合影或演出；
...
“六毛陪伴动作”中可以主动选择专注、加油、抱抱、庆祝、安慰、休息、伸展、想办法、安静陪伴和击掌。“36 个修正版图片动作”按专注、休息、音乐、爱与庆祝、出门冒险分组；音乐动作另提供耳机、吉他和鼓。
...
源码维护在 [leungjunchiang/OnePic-Desktop-Pet](https://github.com/leungjunchiang/OnePic-Desktop-Pet)。`v0.11.0` 计划提供 Lili 的 Windows ZIP、Apple 芯片 Mac DMG、Intel Mac DMG 及各自的 SHA-256 校验文件；旧版本仍保留在 Releases 页面。
