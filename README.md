...
应用和安装文件名为“Lili”，宠物本人仍叫“六毛”。`v0.10.0` 默认站立高度为 160，并提供 100–360 像素连续滑块；新动作统一保留六束紧密红色头发、蓝色发梢、可见小嘴、蓝色锯齿脸、黄色连体衣和粉色爱心。
...
源码维护在 [leungjunchiang/OnePic-Desktop-Pet](https://github.com/leungjunchiang/OnePic-Desktop-Pet)。`v0.10.0` 计划提供 Lili 的 Windows ZIP、Apple 芯片 Mac DMG、Intel Mac DMG 及各自的 SHA-256 校验文件；旧版本仍保留在 Releases 页面。
