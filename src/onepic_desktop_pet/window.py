Warning: truncated output (original token count: 70062)
...
class PetWindow(QWidget):
    ...
    def pause_work_timer(self, reason: str = "") -> CompanionReply:
        ...
        quality_text = (
            f"\n本轮质量：{self._last_focus_quality.label}（{self._last_focus_quality.score}分…10062 tokens truncated…s: list[dict]) -> None:
