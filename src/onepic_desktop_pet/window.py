...
class PetWindow(QWidget):
    ...
    def _pet_name(self) -> str:
        """è¿”å›žå½“å‰æ˜µç§°ï¼›å…¼å®¹æ—§é…ç½®æˆ–æµ‹è¯•æ›¿èº«ç¼ºå°‘è¯¥å­—æ®µçš„æƒ…å†µã€‚"""

        value = str(getattr(self.settings, "pet_name", "å…­æ¯›")).replace("\x00", "").strip()
        return value[:20] or "å…­æ¯›"
