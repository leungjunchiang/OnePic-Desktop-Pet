...
class ChatDialog(QDialog):
    ...
    def __init__(
        ...
        super().__init__(parent)
        self.pet_name = pet_name.strip() or "å…­æ¯›"
        self.setWindowFlags(
        ...
        header.addStretch(1)
        self.rename_button = QPushButton("æ”¹åå­—")
        self.rename_button.setObjectName("softButton")
        self.rename_button.setToolTip("ç‚¹å‡»è¿™é‡Œä¿®æ”¹å…­æ¯›çš„åå­—")
        ...
        privacy = QLabel("ğŸ”’ å¯¹è¯ä¸è½ç›˜ã€‚åœ¨çº¿æ¨¡å¼åªæŠŠå½“å‰æ¶ˆæ¯å’Œæœ€è¿‘å°‘é‡ä¸Šä¸‹æ–‡å‘ç»™æ‰€é€‰ AIã€‚")
    ...
    def set_provider(
        ...
        if provider == "offline":
            ...
            detail = f"{preset.label} Â· {label}" + (f"\n{detail}" if detail else "")
...
class AISettingsDialog(QDialog):
    ...
    def __init__(
        ...
        self.setWindowTitle(f"Lili Â· {(settings.pet_name or 'å…­æ¯›')}è®¾ç½®")
        self.setObjectName("liliPanel")
        ...
        self.pet_name.setPlaceholderText("ä¾‹å¦‚ï¼šå…­æ¯›ã€å›¢å›¢ã€é˜¿æ¯›")
        form.addRow("æ¡Œå® åå­—", self.pet_name)
        ...
        self.always_on_top = QCheckBox("å§‹ç»ˆç½®é¡¶ï¼ˆå…³é—­åä¸ºæ¡Œé¢æ¨¡å¼ï¼Œä¸æŠ¢è¾“å…¥ç„¦ç‚¹ï¼‰")
        ...
        self.allow_autonomous_walk = QCheckBox(
            "å…è®¸å…­æ¯›è‡ªåŠ¨è·‘åŠ¨ï¼ˆé»˜è®¤å…³é—­ï¼›æ‰“å¼€åä¼šåœ¨æ¡Œé¢ä¸Šæ¥å›ç§»åŠ¨ï¼‰"
        )
