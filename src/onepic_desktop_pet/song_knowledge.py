...
_CURATED: dict[str, dict[str, object]] = {
    ...
    "白石洲": {
        "themes": ["深圳漂泊", "城市记忆", "出发与寻找"],
        "emotions": ["克制", "怀念"],
        "imagery": ["白石洲", "深圳", "陌生城市", "驻唱与生活"],
        "liumao_usage": ["用户聊到深圳、漂泊或这首歌时", "用户回望一段努力生活的时期时"],
        "action_hints": ["安静听歌", "陪用户工作"],
        "summary": "这首歌可以理解为对深圳白石洲生活经验的回望：具体地名承载着早年漂泊、工作与驻唱的记忆，也连接着在陌生城市里寻找音乐方向的过程。",
    },
    "荒芜之境": {
        "themes": ["荒野与自我整理", "成长与回望"],
        "emotions": ["孤独", "旷达"],
        "imagery": ["荒岛", "城市", "墙", "荒野", "暗夜", "鹿回头"],
        "liumao_usage": ["用户谈到低谷、回家或重新整理自己时"],
        "action_hints": ["安静陪伴", "暂时不打扰"],
        "summary": "它适合放在一条从荒岛、城市和墙走向荒野与回望的成长线上理解：不是逃离现实，而是在走过漂泊后重新整理自己。",
    },
}
